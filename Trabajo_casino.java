...
public class Trabajo_casino {
    public static final String RESET = "\033[0m";     // Resetear color // Colores para el casino
        ...
        if (monedas < 10) {
            ...
            switch (multi) {
                case 1:
                    ...
                    if (costoPartida > monedas) {
                        System.out.println(ROJO_B+"No tienes suficientes monedas para esta apuesta. Costo: " + costoPartida + " monedas."+RESET);
                        break;
                    }
                    partidas++;
            ...
            switch (multi) {
                case 1:
                    ...
                    if (eleccionm == computadoram) {
                        ...
                        System.out.println(CELESTE+"¡Empate! Se te devuelven tus "+costoPartida+" monedas."+RESET);
                        monedas = monedas + premio;
                        empates++;
                ...
                case 2:
                    ...
                    if (eleccion == computadora) {
                        System.out.println(CELESTE+"¡Empate! Se te devuelven tus 10 monedas."+RESET);
                        monedas = monedas + 10;
                        empates++;
    ...
    public static void verEstadisticas() {
        ...
        System.out.println(CELESTE+"Partidas Empatadas: " + empates+RESET);
    }
    public static void finDelCasino() {
        ...
        System.out.println(CELESTE_B+"Empates: " + empates+RESET);
        if (partidas > 0) {
